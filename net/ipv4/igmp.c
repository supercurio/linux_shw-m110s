...
#if 1 // FIXME, workaround for Android CTS multicast failure
	{
		char *dev_name = in_dev->dev->name;

		if(!memcmp((void*)dev_name, "usb", 3)) // if usbnet
		{
			ip_mc_inc_group(in_dev, htonl(0xE0000003L));
		}
	}
#endif
