...
#if defined(CONFIG_M115S)
// Sony Panel 
const unsigned short sony_SEQ_SETTING[] = {
		// SET_PIXEL_FORMAT
		0x3A, 
		0x177, // 24 bpp
...
// hitachi Panel 
const unsigned short hitachi_SEQ_SETTING[] = {
		0x36, 
		0x100, 
...
const unsigned short nt35510_SEQ_SLEEP_IN[] = {
	0x010,
	SLEEPMSEC, 	155,  // more than 150ms
	ENDDEF, 0x0000
};

const unsigned short nt35510_SEQ_CABC_OFF[] = {
	0x055, 0x100,    // CABC off
	ENDDEF, 0x0000                                
};

const unsigned short nt35510_SEQ_CABC_UI[] = {
	0x055, 0x101, 
	ENDDEF, 0x0000                                
};

const unsigned short nt35510_SEQ_CABC_IMAGE[] = {
	0x055, 0x102,   
	ENDDEF, 0x0000                                
};

const unsigned short nt35510_SEQ_CABC_VIDEO[] = {
	0x055, 0x103, 
	ENDDEF, 0x0000                                
};
#endif  // CONFIG_M115S
