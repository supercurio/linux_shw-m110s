...
/////////////////////////
		...
		if(strncmp(buffer, "1",1)!=0)
	{
			...
			dhd_power_mode= PM_OFF;
			dhd_roam = 1;

			/* Disable MPC */    
			bcm_mkiovar("mpc", (char *)&dhd_power_mode, 4, iovbuf, sizeof(iovbuf));
			dhdcdc_set_ioctl(dhd, 0, WLC_SET_VAR, iovbuf, sizeof(iovbuf));
	...
	/* Set PowerSave mode */
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_PM, (char *)&dhd_power_mode, sizeof(dhd_power_mode));
