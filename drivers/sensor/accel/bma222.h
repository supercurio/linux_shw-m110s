...
*/
#define BMA222_WR_FUNC_PTR char (* bma222_bus_write)(unsigned char, unsigned char *, unsigned char)
...
*/
#define BMA222_BUS_WRITE_FUNC(dev_addr, reg_addr, reg_data, wr_len)\
           bma222_bus_write(reg_addr, reg_data, wr_len)
...
#define BMA222_RD_FUNC_PTR char (* bma222_bus_read)( unsigned char, unsigned char *, unsigned char)
...
#define BMA222_BUS_READ_FUNC(dev_addr, reg_addr, reg_data, r_len)\
           bma222_bus_read(reg_addr, reg_data, r_len)
/** bma222 I2C Address
*/
/*
...
#define C_One_U8X		1
#define C_Two_U8X		2
#define C_Three_U8X		3
#define C_Four_U8X		4
#define C_Five_U8X		5
#define C_Six_U8X		6
#define C_Seven_U8X		7
#define C_Eight_U8X		8
#define C_Nine_U8X		9
#define C_Ten_U8X		10
#define C_Eleven_U8X		11
#define C_Twelve_U8X		12
...
#define BMA222_GET_SENSOR_TYPE           _IOR(BMA222_IOC_MAGIC,92,signed char)
#define BMA222_SET_OFFSET_TARGET_X                        _IOWR(BMA222_IOC_MAGIC,30, short)
#define BMA222_SET_OFFSET_TARGET_Y                        _IOWR(BMA222_IOC_MAGIC,31, short)
#define BMA222_SET_OFFSET_TARGET_Z                        _IOWR(BMA222_IOC_MAGIC,32, short)
#define BMA222_SET_CAL_TRIGGER                        _IOWR(BMA222_IOC_MAGIC,33, short)
#define BMA222_GET_CAL_READY                        _IOWR(BMA222_IOC_MAGIC,34, short)
#define BMA222_SET_EE_W                        _IOWR(BMA222_IOC_MAGIC,35, short)
#define BMA222_SET_EE_PROG_TRIG                        _IOWR(BMA222_IOC_MAGIC,36, short)
#define BMA222_GET_EEPROM_WRITING_STATUS                        _IOWR(BMA222_IOC_MAGIC,37, short)

#define BMA222_FAST_CALIBRATION                        _IOWR(BMA222_IOC_MAGIC,48, short)
#define BMA222_IOC_MAXNR            	48
...
int bma222_fast_calibration(signed char * data);	
#endif
