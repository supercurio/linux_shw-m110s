...
#define DEFAULT_RAW_WAKE_TIME (7*HZ) //SKT request disable FD in LCD On state, so we don't need to use long kernel wakelock
#define DEFAULT_LCDOFF_RAW_WAKE_TIME (7*HZ) //Data for LCD Off
