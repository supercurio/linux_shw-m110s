...
void __init s3cfb_set_platdata(struct s3c_platform_fb *pd)
{
	...
	if (!npd)
		...
		/* Enable double buffering for default window.*/
		npd->nr_buffers[npd->default_win] = CONFIG_FB_S3C_NR_BUFFERS;

		/* Enable double buffering for non-default windows */
#ifdef CONFIG_FB_S3C_WINDOW0
		npd->nr_buffers[0] = CONFIG_FB_S3C_NR_BUFFERS;
#endif
#ifdef CONFIG_FB_S3C_WINDOW1
		npd->nr_buffers[1] = CONFIG_FB_S3C_NR_BUFFERS;
#endif
#ifdef CONFIG_FB_S3C_WINDOW2
		npd->nr_buffers[2] = CONFIG_FB_S3C_NR_BUFFERS;
#endif
#ifdef CONFIG_FB_S3C_WINDOW3
		npd->nr_buffers[3] = CONFIG_FB_S3C_NR_BUFFERS;
#endif
#ifdef CONFIG_FB_S3C_WINDOW4
		npd->nr_buffers[4] = CONFIG_FB_S3C_NR_BUFFERS;
#endif
